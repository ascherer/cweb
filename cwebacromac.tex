...
% searchable underscore in PDF/HINT
\def\\#1{\leavevmode\hbox{\it % 5.24995-3.67998=1.56997
  \ifacrohint\def\_{\kern-.785pt\hbox{\tt\char`\_}\kern-.785pt}\fi
  #1\/\kern.05em}} % italic type for identifiers
\def\&#1{\leavevmode\hbox{\bf % 4.82994-3.67998=1.14996
  \ifacrohint\def\_{\kern-.575pt\hbox{\tt\char`\_}\kern-.575pt}\else
