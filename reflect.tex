...
\M{1\*}This is a quick program to find all canonical forms of reflection
networks
for small $n$.
...
\PB{\&{register}} hints on variables \PB{$\|i,\\{ii},\\{iii},\|j$}, it went up
to 9:09.
...
${}\{{}$\5
\1\&{register} \&{int} \|j;\C{ current place in array }\6
\&{register} \&{int} \|i${},{}$ \\{ii}${},{}$ \\{iii};\C{ general-purpose
indices }\7
\&{if} ${}(\\{argc}\I\T{2}){}$\1\5
