%
% TEX/LATEX $VER: HP8.TEX 1.1 (15.3.1994)
%
...
\lccode`^^af=`^^af \uccode`^^af=0 \catcode`^^af=\active \def ^^af{{\it\$}}

\lccode`^^b1=`^^b2 \uccode`^^b1=`^^b1 \catcode`^^b1=\active \def ^^b1{\'Y}
\lccode`^^b2=`^^b2 \uccode`^^b2=`^^b1 \catcode`^^b2=\active \def ^^b2{\'y}
\lccode`^^b3=`^^b3 \uccode`^^b3=0 \catcode`^^b3=\active \def ^^b3{$^\circ$}
...
\lccode`^^b8=`^^b8 \uccode`^^b8=0 \catcode`^^b8=\active \def ^^b8{{!`}}
\lccode`^^b9=`^^b9 \uccode`^^b9=0 \catcode`^^b9=\active \def ^^b9{{?`}}

\lccode`^^bb=`^^bb \uccode`^^bb=0 \catcode`^^bb=\active \def ^^bb{{\it\$}}

\lccode`^^bd=`3 \uccode`^^bd=`^^bd \catcode`^^bd=\active \def ^^bd{{\S}}
...
\lccode`^^de=`^^de \uccode`^^de=`\? \catcode`^^de=\active \def ^^de{{\ss}}
...
\lccode`^^ee=`^^ee \uccode`^^ee=0 \catcode`^^ee=\active \def ^^ee{\"Y}
\lccode`^^ef=`^^ef \uccode`^^ef=0 \catcode`^^ef=\active \def ^^ef{\"y}

\lccode`^^f3=`^^f3 \uccode`^^f3=0 \catcode`^^f3=\active \def ^^f3{$\mu$}
\lccode`^^f4=`^^f4 \uccode`^^f4=0 \catcode`^^f4=\active \def ^^f4{{\P}}

\lccode`^^fe=`^^fe \uccode`^^fe=0 \catcode`^^fe=\active \def ^^fe{$\pm$}
