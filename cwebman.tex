...
\def\runninghead{{\tentt CWEB} USER MANUAL (VERSION 3.5)}
...
\vskip 18pt\centerline{(Version 3.5)}
\vskip 24pt
...
$$\lpile{\.{\\def\\topofcontents\{\\null\\vfill}\cr
  ...
  \.{ { }\\vskip 15pt \\centerline\{(Version 3.5)\}{ }\\vfill\}}\cr}$$
