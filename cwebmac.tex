...
\xdef\fmtversion{\fmtversion+CWEB3.61}
\newif\ifpdf
\ifx\pdf+\pdftrue\fi
...
\ifpdftex\def\pdflink#1#2{\hbox{\pdfannotlink attr{/Border [0 0 0]} goto num #1
...
\outer\def\N#1#2#3.{\gdepth=#1\gtitle={#3}\MN{#2}% beginning of starred section
  ...
  \ifpdftex\pdfoutline goto num \secno {#3}
  \else\ifpdf\special{pdf: outline #1 << /Title (#3) /Dest
