...
%     \let\*=\empty\pdfdest num \secstar fith}} % bad space in versions < 3.68
  ...
  \else\ifpdf\smash{\raise\baselineskip\hbox to0pt{%
     ...
     \special{color push rgb 1 0 0}\smash{\llap{\vrule height 10pt width 10pt}}\special{color pop}}}\fi\fi}
...
\outer\def\N#1#2#3.{% beginning of starred section
  ...
  \ifpdf\special{pdf: outline #1 << /Title (\the\toksE) /Dest
    [ @thispage /FitH @ypos ] >>}%
    \special{color push rgb 0 0 1}\smash{\llap{\vrule height 10pt width 10pt}}\special{color pop}\fi
...
%  \ifpdftex \makebookmarks \pdfdest name {NOS} fitb % in versions < 3.68
  ...
  \else\ifpdf
    ...
    \special{color push rgb 0 1 0}\smash{\llap{\vrule height 10pt width 10pt}}\special{color pop}
    \def\X##1:##2\X{\Xpdf##1:##2\X \firstsecno##1.%
      {\toksF={}\makeoutlinetoks##2\outlinedone\outlinedone}%
