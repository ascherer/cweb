...
% Version 4.8.1 --- June 2022
\ifx\renewenvironment\undefined\else\endinput\fi % LaTeX will use other macros
\xdef\fmtversion{\fmtversion+CWEB4.8.1}
\chardef\cwebversion=4 \chardef\cwebrevision=8 \chardef\cwebsubrevision=1
...
\def\fin{\par\vfill\eject % this is done when we are ending the index
  ...
  \ifpdf \ifpdftex \makebookmarks % added in Version 3.68
    \countsections \fi\fi % and in Version 4.8.1
