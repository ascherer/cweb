...
% the index formatting operator \I to read the index entry and write it
...
\string\bigskip}%
\makeCRother
\def\I{\setupverbatim\getinxline\I}%
\gobbleCR
}

% Likewise \fin, instead of typesetting the section list, redefines
% the formatting operators \I, \U, \Us to write the lines of the
...
\def\I{\setupverbatim\getsecline\I}%
\gobbleCR
}
